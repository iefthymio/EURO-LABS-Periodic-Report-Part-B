...
R\&D across Europe.
    ...
    \begin{tabular}{|l|*{8}{>{\centering\arraybackslash}p{0.084\textwidth}|}}
        ...
        \rowcolor{white} \cellcolor{mylightergray}\textit{Participant short name} & CERN & UU & CEA & KIT
                                                                                  & INFN & INCT & UKRI & CNRS \\
        \hline
        \rowcolor{white} \cellcolor{mylightergray}\textit{PM per participant~\footnotemark} & 16.5 & 20 & 20 & 24 & 21 & 16 & 6 & 13\\
        \hline        
    \end{tabular}
    }
\end{table}
...
WP3 had no Milestones or Deliverables in the reference period. 
